...
exports.driverSignUpForm = function(req, res){
	...
	exports.driverRideHistory = function(req, res){
		var Driver_ID=req.session.username;
	var driverBillHistory =  " select * from UBER.Ride_History natural join UBER.Driver natural join UBER.Customer where Driver_ID =  "+Driver_ID;
